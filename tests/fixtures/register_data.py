...
def make_inverter_cache() -> RegisterCache:
    ...
    hr_data = {
        ...
        7: 1,  # enable_ammeter
        8: 0x4459, 9: 0x3232, 10: 0x3138, 11: 0x4720, 12: 0x3031,  # battery serial DY2218G001
        13: 0x4641, 14: 0x3234, 15: 0x3234, 16: 0x4734, 17: 0x3033,  # inverter serial FA2424G403
        ...
        35: 26, 36: 4, 37: 9, 38: 14, 39: 13, 40: 50,  # system_time
        47: 1,  # meter_type
        50: 100,  # active_power_rate
        53: 0x0100,  # enable_inverter=True
        54: 1,  # battery_type lithium
        55: 819,  # battery_nominal_capacity
        56: 800, 57: 900,  # discharge_slot_1: 08:00-09:00
        59: 0,  # enable_discharge
        94: 2330, 95: 530,  # charge_slot_1: 23:30-05:30
        96: 1,  # enable_charge
        110: 4,  # battery_soc_reserve
        111: 50, 112: 50,  # charge/discharge limits
    ...
    ir_data = {
        ...
        3: 4279,  # v_p_bus
        5: 2459,  # v_ac1: 245.9V
        6: 1, 7: 18777,  # e_battery_throughput_total
        8: 37,  # i_pv1: 3.7A
        9: 37,  # i_pv2: 3.7A
        10: 64,  # i_ac1: 6.4A
        11: 0, 12: 57242,  # e_pv_total
        13: 5004,  # f_ac1: 50.04Hz
        17: 48,  # e_pv1_day: 4.8kWh
        18: 1021,  # p_pv1: 1021W
        19: 30,  # e_pv2_day: 3.0kWh
        20: 619,  # p_pv2: 619W
        21: 1, 22: 6370,  # e_grid_out_total
        24: 1440,  # p_inverter_out
        25: 35,  # e_grid_out_day: 3.5kWh
        26: 53,  # e_grid_in_day: 5.3kWh
        27: 0, 28: 34172,  # e_inverter_in_total
        30: 1302,  # p_grid_out
        32: 2, 33: 4216,  # e_grid_in_total
        ...
        45: 1, 46: 13461,  # e_inverter_out_total
        49: 1,  # system_mode
...
def make_battery_cache() -> RegisterCache:
    ...
    ir_data = {
        60: 3349, 61: 3351, 62: 3338, 63: 3337,
        64: 3338, 65: 3340, 66: 3340, 67: 3353,
        68: 3341, 69: 3341, 70: 3341, 71: 3343,
        72: 3343, 73: 3340, 74: 3340, 75: 3341,
        76: 186, 77: 180, 78: 181, 79: 186,
        80: 53477, 81: 202,
        82: 0, 83: 53543,
        84: 0, 85: 15526,
        86: 0, 87: 16000,
        88: 0, 89: 15233,
        96: 570, 97: 16, 98: 3020,
        100: 98,
        103: 186, 104: 180,
        105: 41729, 106: 42585,
        110: 0x4459, 111: 0x3232, 112: 0x3138, 113: 0x4730, 114: 0x3031,
    }
    for reg, val in ir_data.items():
        cache[IR(reg)] = val
    return cache
